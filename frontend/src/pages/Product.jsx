        ...
        <div className="container" style={{paddingTop: '120px'}}>
            <div className="product-details-container animate-fade-in" style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: '60px', alignItems: 'center' }}>
                <div className="product-gallery" style={{position: 'relative'}}>
                    ...
                    <img src={imageUrl} alt={product.title} style={{width: '100%', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-subtle)', objectFit: 'cover', aspectRatio: '4/5'}} onError={(e) => { e.target.onerror = null; e.target.src = 'http://localhost:5000/uploads/hero_image.png'; }} />
                </div>
                <div className="product-info-section">
                    ...
                    <div className="p-price" style={{fontSize: '2rem', fontWeight: '700', color: 'var(--text-main)', marginBottom: '30px'}}>₹{product.price.toFixed(2)}</div>
                    ...
                    <button className="btn btn-primary" style={{width: '100%', padding: '18px', fontSize: '1.2rem', borderRadius: 'var(--radius-md)'}} onClick={() => { addToCart(product); alert('Added to Cart!'); }}>
